...
import com.jyujuy.dayonetest.IntegrationTest;
import com.jyujuy.dayonetest.MyCalculator;
import com.jyujuy.dayonetest.model.StudentScoreFixture;
...
public class StudentScoreServiceIntegrationTest extends IntegrationTest {
    ...
    @Autowired
    private EntityManager entityManager; // 강제로 쿼리가 날라갈수있도록 설정
    @Test
    public void savePassedStudentScoreTest() {
        ...
        Assertions.assertEquals(calculator
