...
public class StudentScoreServiceMockTest {
  ...
  public void saveScoreMockTest() {
    ...
    //        StudentPass expectStudentPass =
    // StudentPass.builder().studentName(expectStudentScore.getStudentName()).exam(expectStudentScore.getExam()).avgScore((new MyCalculator(0.0)).add(expectStudentScore.getKorScore().doubleValue()).add(expectStudentScore.getEnglishScore().doubleValue()).add(expectStudentScore.getMathScore().doubleValue()).divide(3.0).getResult()).build();
  ...
  public void saveScoreMockTest2() {
    ...
    //        StudentFail expectStudentFail =
    // StudentFail.builder().studentName(expectStudentScore.getStudentName()).exam(expectStudentScore.getExam()).avgScore((new MyCalculator(0.0)).add(expectStudentScore.getKorScore().doubleValue()).add(expectStudentScore.getEnglishScore().doubleValue()).add(expectStudentScore.getMathScore().doubleValue()).divide(3.0).getResult()).build();
  ...
  public void getPassStudentsListTest() {
    ...
    //        StudentPass notExpectStudent3 =
    // StudentPass.builder().id(3L).studentName("iamnot").exam("secondExam").avgScore(90.0).build();
    ...
    //        responses.forEach((response) -> System.out.println(response.getStudentName() + " " +
    // response.getAvgScore()));
  ...
  public void getFailStudentsListTest() {
    ...
    //        StudentFail notExpectStudent3 =
    // StudentFail.builder().id(1L).studentName("jyujyu").exam("secondExam").avgScore(70.0).build();
    //        StudentFail expectStudent1 =
    // StudentFail.builder().id(2L).studentName("test").exam(givenTestExam).avgScore(80.0).build();
    //        StudentFail expectStudent2 =
    // StudentFail.builder().id(3L).studentName("iamnot").exam(givenTestExam).avgScore(90.0).build();
